...
- ![수정 아이콘](../../assets/fix.svg) **Valkey 8.5 기능 테스트 적용 범위**—Symfony L2 캐시 구성에 대한 적용 범위가 개선되었습니다.<!-- MCLOUD-15487 -->
- ![아이콘 수정](../../assets/fix.svg) **캐싱 개선**—페이지 캐시 격리 문제를 해결했습니다.<!-- MCLOUD-15509 -->
- ![수정 아이콘](../../assets/fix.svg) **Redis 및 Valkey 개선 사항**—기존 및 최신(Symfony Cache, 2.4.9+) Redis 및 Valkey 캐시 구성을 모두 지원하도록 `REDIS_BACKEND` 및 `VALKEY_BACKEND` 처리가 개선되었습니다.<!-- MCLOUD-15546 -->
...
- ![새 아이콘](../../assets/new.svg) **RabbitMQ**—RabbitMQ 4.3 지원이 추가되었습니다.<!-- MCLOUD-15088 -->
- ![수정 아이콘](../../assets/fix.svg) **Redis Lua 구성** - `USE_LUA_ON_GC` 지원이 추가되었으며 더 이상 사용되지 않는 `LUA_KEY`.<!-- MCLOUD-15048 -->
- ![고정 아이콘](../../assets/fix.svg) **Symfony L2 캐시** - Adobe Commerce 2.4.9 캐시 구성과 ece-tools 호환성 수정<!-- MCLOUD-15114 -->
...
- ![새 아이콘](../../assets/new.svg) **PHP 8.5**—PHP 8.5에 대한 지원이 추가되었습니다.<!-- MCLOUD-14179 -->
- ![수정 아이콘](../../assets/fix.svg) **기능 테스트 업데이트됨**-Valkey 8.1, 8,2 및 Redis 8.4 테스트 업데이트됨<!-- MCLOUD-13983 -->
- ![수정 아이콘](../../assets/fix.svg) **MariaDB,PHP 및 Opensearch Validator를 업데이트했습니다**-유효성 검사기 스크립트를 업데이트했습니다.<!-- MCLOUD-14574/MCLOUD-14466 -->
- ![수정 아이콘](../../assets/fix.svg) **EOL 유효성 검사기**-EOL(서비스 종료) 날짜가 업데이트되었습니다.<!-- MCLOUD-14272 -->
...
- ![새 아이콘](../../assets/new.svg) **OpenSearch**—다음 Adobe Commerce 릴리스 2.4.6에 대해 `opensearch` 엔진을 구성하고 설정하는 기능이 추가되었습니다. [OpenSearch 서비스 설정](../services/opensearch.md).<!-- MCLOUD-9236 -->을 참조하세요.
...
- 새 Commerce 2.4.5 설치 시 ![아이콘 수정](../../assets/fix.svg) **[!DNL RabbitMQ]문제**—새 Commerce 2.4.5에서 [!DNL RabbitMQ] 충돌 문제가 수정되었습니다. 설치.<!-- MCLOUD-9059 -->
...
- ![새 아이콘](../../assets/new.svg) **유효성 검사 개선 사항**—
  ...
  - ![새 아이콘](../../assets/new.svg) **서비스 버전 및 EOL 유효성 검사 업데이트**—Adobe Commerce 2.4에 대해 설치된 서비스 버전을 확인하기 위해 유효성 검사를 업데이트했습니다. 요구 사항.<!--MCLOUD-6144-->
...
>[!NOTE]
>
>ECE-Tools 버전 2002.1.0으로 업데이트하기 전에 [이전 버전과 호환되지 않는 변경 사항](backward-incompatible-changes.md)을 검토하여 클라우드 인프라 프로젝트 구성 또는 프로세스에서 Adobe Commerce을 업데이트해야 하는 변경 사항에 대해 알아보십시오.
