...
- ![새 아이콘](../../assets/new.svg) **비마스터 노드에 대한 읽기 전용 연결 구성**—이 릴리스에는 읽기 전용 트래픽을 수신하도록 비마스터 노드에 대한 읽기 전용 연결을 구성하는 기능이 추가됩니다([MariaDB](../environment/variables-deploy.md#mysql_use_slave_connection)용).<!--MAGECLOUD-143 -->[Redis](../environment/variables-deploy.md#redis_use_slave_connection) 및 <!--MAGECLOUD-143 -->용)
