...
- ![수정 아이콘](../../assets/fix.svg) **패치**-체크아웃 중단(AC-15867) 및 Newrelic(ACSD-68617)에 대한 수정.<!-- MCLOUD-14191 -->
- ![수정 아이콘](../../assets/fix.svg) **개선된 범주 보기** - MCLOUD-13752: 범주 보기 개선<!-- MCLOUD-13752 | MCLOUD-14139  - -->
