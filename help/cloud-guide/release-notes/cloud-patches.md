...
- ![새 아이콘](../../assets/new.svg) **Commerce 2.4.4에서 2.4.8**(으)로 업데이트된 패치—이 업데이트는 1.1.7<!-- MCLOUD-13619 -->에 릴리스된 [CVE-2025-24434](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27148)의 패치를 수정합니다.
