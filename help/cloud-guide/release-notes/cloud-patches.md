...
- ![수정 아이콘](../../assets/fix.svg) **패치** - *Commerce 기술 자료&quot;(티켓 AC-15867 및 ACSD-68617)에 설명된 문제([)로 인해 &#x200B;](https://experienceleague.adobe.com/ko/docs/experience-cloud-kcs/kbarticles/ka-27997)JS 축소 및 번들링이 사용되면 체크아웃 오류가 발생합니다.<!-- MCLOUD-14191 -->
...
- ![아이콘 수정](../../assets/fix.svg) **개선된 범주 보기**-개선된 범주 보기 CVE-2025-47109<!-- MCLOUD-13752	 - -->
