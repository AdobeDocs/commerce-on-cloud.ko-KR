...
- ![수정 아이콘](../../assets/fix.svg) **보안 개선 사항**-[Adobe Commerce 보안 업데이트 APSB26-92](https://helpx.adobe.com/security/products/magento/apsb26-92.html)에서 참조된 보안 수정 사항을 적용했습니다.<!--MCLOUD-15035 -->
...
- ![수정 아이콘](../../assets/fix.svg) **보안 개선 사항**-[Adobe Commerce 보안 업데이트 APSB26-73](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-37421)에서 참조된 보안 수정 사항을 적용했습니다.<!--MCLOUD-15066 -->
...
- ![새 아이콘](../../assets/new.svg) **PHP 8.5**—PHP 8.5에 대한 지원이 추가되었습니다.<!-- MCLOUD-14181 -->
- ![수정 아이콘](../../assets/fix.svg) **PHP 8.x에 대한 기능 테스트를 업데이트했습니다**—기존 PHP 7.x 테스트를 제거하고, PHP 8.1 및 8.2를 새로 추가하고, Adobe Commerce 버전을 업데이트했습니다.<!-- MCLOUD-14203 -->
...
- ![수정 아이콘](../../assets/fix.svg) **패치** - *Commerce 기술 자료*&#x200B;에 설명된 [JS 축소 및 번들링을 사용할 수 있을 때 체크 아웃에 대한 수정 실패](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27997) 문제
