...
- ![수정 아이콘](../../assets/fix.svg) **패치** - [Commerce 기술 자료](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27997)에 설명된 *JS 축소 및 번들링을 사용할 수 있을 때 체크 아웃에 대한 수정 실패* 문제
