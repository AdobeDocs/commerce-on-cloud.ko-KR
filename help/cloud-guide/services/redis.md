...
_구현 플레이북 모범 사례 안내서_&#x200B;에서 [Redis 구성](https://experienceleague.adobe.com/en/docs/commerce-operations/implementation-playbook/best-practices/planning/redis-valkey-service-configuration)을 참조하십시오.
