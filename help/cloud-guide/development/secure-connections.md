...
>[!NOTE]
>Pro Staging 및 프로덕션의 경우, sFTP 연결이 _not_&#x200B;이(가) 필요한 **일반** 사용자용인 경우[클라우드 프로젝트에 추가](../project/user-access.md)해야 합니다. [공개](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide.html?lang=ko#submit-ticket) 키가 첨부된 **Adobe Commerce 지원 티켓을 제출**&#x200B;해야 합니다. **개인 SSH 키를 제공하지 않습니다.**
