...
Adobe Commerce 코드 베이스를 최신 버전으로 업그레이드할 수 있습니다. 프로젝트를 업그레이드하기 전에 [설치](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/system-requirements.html?lang=ko) 안내서의 _시스템 요구 사항_&#x200B;에서 최신 소프트웨어 버전 요구 사항을 검토하십시오.
